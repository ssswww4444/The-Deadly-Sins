...
$("#table-select1 a").click(function(e){
    ...
    if (selText1 === "North Melbourne"){
        ...
        var myPieChartt = new Chart(ctx3, {
            type: 'pie',
            data: {
                labels: ['passion', 'desire', 'want', 'joy', 'pleasure', 'longing', 'sensuality'],
                datasets: [{
            ...
            options: {
                ...
                title: {
                  display: true,
                  text: 'Wrath: North Melbourne Pie Chart'
                }
            }
        });
    }

    if (selText1 === "Richmond"){
        ...
        var myPieChart = new Chart(ctx3, {
            ...
            options: {
                ...
                title: {
                  display: true,
                  text: 'Wrath: Richmond Pie Chart'
                }
            }
        });
    }
    if (selText1 === "South Melbourne"){
        ...
        var myPieChart = new Chart(ctx3, {
            ...
            options: {
                ...
                title: {
                  display: true,
                  text: 'Wrath: South Melbourne Pie Chart'
                }
            }
        });
    }
